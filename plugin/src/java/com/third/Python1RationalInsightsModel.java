 ...
 *
 */
public class Python1RationalInsightsModel extends PythonWrapperNodeModel<Python1RationalInsightsConfig> {
    /**
     * Constructor for the node model.
     */
    protected Python1RationalInsightsModel() {
    ...
    @Override
    protected Python1RationalInsightsConfig createConfig() {
        return new Python1RationalInsightsConfig();
    }
